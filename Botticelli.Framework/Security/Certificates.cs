                ...
                return new HttpClientHandler
                {
                    ...
                    ServerCertificateCustomValidationCallback =
                             ...
                             policyErrors) =>
                            {
                                ...
                                return true;
                                #endif
                                if (settings.SecuritySettings?.AllowSelfSignedServerCertificate is true) return true;

                                if (!cert.Thumbprint.Equals(settings.SecuritySettings?.ServerCertificateThumbprint, StringComparison.OrdinalIgnoreCase)) return false;
