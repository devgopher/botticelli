...
export SecureStorageSettings__ConnectionString="Filename=/tmp/database.db;Connection=shared;Password=$db_password"
...
docker run -d botticelli_server_back_dev:0.6 \
	-p 7247:7247 \
	-p 5042:5042 \
