...
public static class ServiceCollectionExtensions
{
    ...
    /// <returns></returns>
    public static IServiceCollection AddSqliteBasicBotUserAuth(this IServiceCollection services, IConfiguration config, Action<DbContextOptionsBuilder>? dbParameters = null)
    {
