...
export SecureStorageConnectionString="User ID=postgres;Password=<secret>;Host=127.0.0.1;Port=5432;Database=botticelli_analytics;Pooling=true;Min Pool Size=0;Max Pool Size=100;Connection Lifetime=0;"
